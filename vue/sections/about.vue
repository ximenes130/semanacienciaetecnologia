<template>
     <div>
          <v-container>
			<v-row>
				<v-col xs12 xl10 offset-xl1>
					<v-carousel>
						<v-carousel-item src="img/carrousel/1.jpg"></v-carousel-item>
						<v-carousel-item src="img/carrousel/2.jpg"></v-carousel-item>
						<v-carousel-item src="img/carrousel/3.jpg"></v-carousel-item>
					</v-carousel>
					<br>
