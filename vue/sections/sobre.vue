	...
	<div>
		<v-card>
			<v-card-row class="blue-grey darken-1">
				...
				<v-parallax src="img/logo.png" height="400" >
			</v-card-row>
			</v-parallax>
...
.parallax{
	width: 100%;
     height: 100%;
     background: url("https://img.gifamerica.com/d0921ca808b92e972f04e42f36f1d205_estrelas-estrelas-no-ceu-gif_498-574.gif");
}
#parallax-bg{
    width: 100%;
    height: 589px;
